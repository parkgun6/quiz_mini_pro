...
<form action="/user/qnaboard/list">
...
<form action="/user/qnaboard/modify" method="get" class="form-horizontal">
<input type="hidden" name="action">   <!-- action -->
<table class="table table-striped table-bordered">
	<tr>
		<th>게시글번호</th>
		<td><input type="number" class="form-control" name="bno" value="${board.bno }" readonly="readonly"></td>
	</tr>
	<tr>
		<th>작성자</th>                                    <!-- 작성자 입력 -->
		<td><input type="text" class="form-control" name="mid" value="${board.mid}" readonly="readonly"></td>
	</tr>
	<tr>
		<th>퀴즈번호</th>
	...
	<tr>
		<th>내용</th>                                     <!-- 내용 입력 -->
		<td><textarea rows="10" class="form-control" name="content"  readonly="readonly">${board.content}</textarea></td>
	</tr>
	<tr>
		<th>날짜</th>                                     <!-- 제목 입력 -->
		<td><input type="Date" class="form-control" name="regdate" value='${board.regdate}' readonly="readonly"></td>
	</tr>
...
<form action="/user/qnaboard/remove" method='post'>
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
...
<br><br>
<input type="text" class="form-control" name="bno" value="아직 관리자의 답변이 달리지 않았습니다." readonly="readonly">
</c:if>
<br>
<br>
<br>
