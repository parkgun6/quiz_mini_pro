...
<form action="/user/qnaboard/register" method="post" class="form-horizontal">
<input type="hidden" name="action">   <!-- action -->
<table class="table table-striped table-bordered">
	<tr>
		<th>ID</th>
		<td><input type="number" class="form-control" name="qno" value="${qno}" readonly="readonly"></td>
	</tr>
	<tr>
		<th>카테고리</th>
		<td><input type="number" class="form-control" name="category" placeholder="1"></td>
	</tr>
	<tr>
		<th>제목</th>                                     <!-- 제목 입력 -->
