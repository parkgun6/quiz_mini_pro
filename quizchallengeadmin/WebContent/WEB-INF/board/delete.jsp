...
<form class="form-horizontal" action="/board/delete" method="post">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="writer" placeholder="${board.writer}" readonly="readonly">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="title" placeholder="${board.title}" readonly="readonly">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="content" placeholder="${board.content}" readonly="readonly">
    </div>
  </div>
